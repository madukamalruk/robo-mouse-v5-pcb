...
> [!IMPORTANT]
> Below is the complete CubeMX peripheral configuration for the **Obo-Mouse V4 Upgraded** firmware. Please update the STM32CubeMX `.ioc` project with these new peripherals to match the updated PCB connections.
